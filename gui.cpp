...
void gui::DerstroyImGui() noexcept
{
...
void gui::Render() noexcept
{
	...
	if (!p_jni) {
		printf("ERROR: p_jni is NULL in GUI, creating a new instance...\n");
		p_jni = std::make_unique<JNI>();  // Try creating it
	}
	...
	//ImGui::Button("Set RightClick Delay to 0")
	ImGui::LabelText("To detach press PGUP", "To apply settings close this window!");
	if (ImGui::Button("Set RightClick Delay to 0"))
	{
		g_Globals.rcDelay = true;
	...
	{
		g_Globals.autoclick = true;
		printf("[+]AutoClicker will be enabled!\n");
	}
